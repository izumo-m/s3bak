...
2. [Getting started](02-getting-started.md) — requirements, installation,
   bucket preparation, a minimal `config.py`, and the first push, status,
   and pull.
...
7. [Operating s3bak](07-operating.md) — the recommended routine, unattended
   runs, hooks and `S3BAK_JOURNAL`, IAM permissions, storage classes and
   bucket versioning.
